...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [LAYER_NORM_BASE] = LAYOUT_matroid(
        ...
        KEY_FORWARD_LAYER(LAYER_NORM_EXTENSION), KC_A, KC_R, KC_S, KC_T, KC_D, KC_H, KC_N, KC_E, KC_I, KC_O, KEY_FORWARD_LAYER(LAYER_NORM_EXTENSION), KC_ENT, KEY_FORWARD_LAYER(LAYER_DESKTOP),
    ...
    [LAYER_NORM_EXTENSION] = LAYOUT_matroid(
        ...
        KC_NO, LALT(KC_LEFT), LALT(KC_RIGHT), KC_BSPC, LGUI(KC_LEFT), LCTL(KC_E), KC_LEFT, KC_DOWN, KC_UP, KC_RIGHT, LGUI(KC_V), KC_NO, KEY_CREATE_NEXT_LINE, KEY_FORWARD_LAYER(LAYER_DESKTOP),
    ...
    [LAYER_RACE_BASE] = LAYOUT_matroid(
        ...
        KEY_FORWARD_LAYER(LAYER_RACE_EXTENSION), KC_A, KC_R, KC_S, KC_T, KC_D, KC_H, KC_N, KC_E, KC_I, KC_O, KEY_FORWARD_LAYER(LAYER_RACE_EXTENSION), KC_ENT, KC_NO,
    ...
    [LAYER_RACE_EXTENSION] = LAYOUT_matroid(
    ...
    [LAYER_LEGACY_BASE] = LAYOUT_matroid(
        ...
        KEY_FORWARD_LAYER(LAYER_LEGACY_EXTENSION), KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L, KC_SCLN, KEY_FORWARD_LAYER(LAYER_LEGACY_EXTENSION), KC_ENT, KEY_FORWARD_LAYER(LAYER_DESKTOP),
        KC_CAPS, KC_LSFT, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_QUOT, KC_RSFT, KC_NO, LCTL(KC_LEFT),
        KC_LCTL, KC_LGUI, KC_LALT, KC_SPC, KEY_FORWARD_LAYER(LAYER_CONTROL), KC_SPC, KC_RALT, KC_RGUI, KC_NO, KC_NO, LCTL(KC_RIGHT)),
    [LAYER_LEGACY_EXTENSION] = LAYOUT_matroid(
    ...
    [LAYER_CONTROL] = LAYOUT_matroid(
        ...
        KC_NO, LALT(KC_LEFT), LALT(KC_RIGHT), KC_BSPC, LGUI(KC_LEFT), LCTL(KC_E), KC_LEFT, KC_DOWN, KC_UP, KC_RIGHT, LGUI(KC_V), KC_NO, KEY_CREATE_NEXT_LINE, KC_NO,
